...
**Grid Area** is the space created by the intersection of four grid lines. In other words, it is a collection of one or more adjacent grid items. ⚠️ Grid area can only be rectangular! It is not possible to create T- or L-shaped grid areas. Which for some reason was the first thing I wanted to do.
